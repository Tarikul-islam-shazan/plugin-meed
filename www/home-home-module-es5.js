(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["home-home-module"], {
    ...
    function node_modulesRawLoaderDistCjsJsSrcAppHomeHomePageHtml(module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_exports__["default"] = "<ion-header [translucent]=\"true\">\n  <ion-toolbar>\n    <ion-title>\n      Socure\n    </ion-title>\n  </ion-toolbar>\n</ion-header>\n\n<ion-content [fullscreen]=\"true\">\n\n  <ion-button (click)=\"checkPermissions()\">Check Permissions</ion-button>\n  <ion-button (click)=\"scanLicense()\">Scan License</ion-button>\n  <ion-button (click)=\"scanPassport()\">Scan Passport</ion-button>\n  <ion-button (click)=\"scanSelfie()\">Scan Selfie</ion-button>\n  <ion-button (click)=\"openSetting()\">Open Setting</ion-button>\n</ion-content>\n";
      /***/
    },
      ...
      var HomePage = /*#__PURE__*/function () {
        ...
        _createClass(HomePage, [{
          ...
          value: function checkPermissions() {
            var permissions = ['camera', 'location'];
            meed.plugins.Socure.checkPermissions(permissions, function (result) {
              console.log(result);
            }, function (err) {
              console.log(err);
            });
          ...
          key: "scanLicense",
          value: function scanLicense() {
            meed.plugins.Socure.scanLicense(function (result) {
              console.log(result);
            }, function (err) {
              console.log(err);
            });
          ...
          key: "scanPassport",
          value: function scanPassport() {
            meed.plugins.Socure.scanPassport(function (result) {
              console.log(result);
            }, function (err) {
              console.log(err);
            });
          ...
          key: "scanSelfie",
          value: function scanSelfie() {
            meed.plugins.Socure.scanSelfie(function (result) {
              console.log(result);
            }, function (err) {
              console.log(err);
            });
          ...
          value: function openSetting() {
            meed.plugins.Socure.openSetting(function (result) {
              console.log(result);
            }, function (err) {
              console.log(err);
            });
