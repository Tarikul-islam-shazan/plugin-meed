...
let HomePage = class HomePage {
    ...
    checkPermissions() {
        ...
        meed.plugins.Socure.checkPermissions(permissions, (result) => {
            console.log(result);
        }, (err) => {
            console.log(err);
        });
    ...
    scanLicense() {
        meed.plugins.Socure.scanLicense((result) => {
            console.log(result);
        }, (err) => {
            console.log(err);
        });
    ...
    scanPassport() {
        meed.plugins.Socure.scanPassport((result) => {
            console.log(result);
        }, (err) => {
            console.log(err);
        });
    ...
    scanSelfie() {
        meed.plugins.Socure.scanSelfie((result) => {
            console.log(result);
        }, (err) => {
            console.log(err);
        });
    ...
    openSetting() {
        meed.plugins.Socure.openSetting((result) => {
            console.log(result);
        }, (err) => {
            console.log(err);
        });
